export default {
    ...
    StoreEnergyInSpawns: function (creep: Creep) {
    ...
    StoreEnergyInTowers: function (creep: Creep) {
    ...
    StoreEnergyInStorage: function (creep: Creep) {
    ...
    WithdrawEnergyFromContainer: function (creep: Creep) {
        let targets = creep.room.find(FIND_STRUCTURES, {
            filter: (structure) => {
    ...
    WithdrawEnergyFromLink: function (creep: Creep) {
